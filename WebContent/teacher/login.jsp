		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="javascript:void(0)"><span class="glyphicon glyphicon-log-in">&nbsp;教师登录</span></a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container" style="justify-content: center; align-items: center; margin-top: 150px">
		<div class="row">
			...
			<div class="col-sm-4 col-md-4 col-lg-4">
				<form id="loginForm" formname="loginForm" method="post" action="${pageContext.request.contextPath }/teacherlogin" onsubmit="return check(this)">
					<h2 class="text-center">欢迎教师登录</h2>${login_msg }
					<input type="text" name="teacher_id" class="form-control" placeholder="账号" autofocus>
					<p></p>
					<input type="password" name="teacher_pwd" class="form-control" placeholder="密码">
					<br>
