		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li ><a href="studentInfo.jsp"><span class="glyphicon glyphicon-user">&nbsp;${user.stu_name}</span></a></li>
					<li ><a href="work.jsp"><span class="glyphicon glyphicon-tasks">&nbsp;作业信息</span></a></li>
